 # 2 Decision Code
# This code will  display the pattern at 0 degree tilt or 90 degrees, testing various eccentricities
...
if recordData:
    ...
    expName = 'Gabor Two Decision Covert'
...
for pair in pairs:
    ...
    win.flip()
    keys = event.waitKeys(timeStamped = True, keyList = ['v', 'b', 'escape'])
    key = keys[0]
    if key[0] == 'escape':
        endExp()
    times['end'] = key[1]
